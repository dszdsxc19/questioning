...
source_path: cs/network-series/packet-capture-tools.mdx
migrate_from: cs/network-series/packet-capture-tools.mdx
migrate_batch: blog-vault-migration-2026-03-18
summary: 逛阮一峰科技周刊时好奇凭证由来，于是深入研究抓包原理与工具。
publish: blog
publish_slug: cs/network-series/packet-capture-tools
draft: false
---
