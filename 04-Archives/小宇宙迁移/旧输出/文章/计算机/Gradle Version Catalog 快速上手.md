...
source_path: cs/backend-series/gradle-version-catalog.mdx
migrate_from: cs/backend-series/gradle-version-catalog.mdx
migrate_batch: blog-vault-migration-2026-03-18
summary: 记录统一依赖版本管理的好处与最小示例。
publish: blog
publish_slug: cs/backend-series/gradle-version-catalog
draft: false
---
