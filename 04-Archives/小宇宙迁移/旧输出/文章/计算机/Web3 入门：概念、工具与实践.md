...
source_path: cs/web-series/web3/web3-intro-guide.mdx
migrate_from: cs/web-series/web3/web3-intro-guide.mdx
migrate_batch: blog-vault-migration-2026-03-18
summary: 从理念到实践，了解 Web3 的核心概念、技术基础和开发工具，以及它到底有没有用。
migration_flags:
- contains_import
publish: blog
publish_slug: cs/web-series/web3/web3-intro-guide
draft: false
---
