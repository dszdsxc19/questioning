...
source_path: cs/frontend-series/npm-series/npm-npx-package-json.mdx
migrate_from: cs/frontend-series/npm-series/npm-npx-package-json.mdx
migrate_batch: blog-vault-migration-2026-03-18
summary: 梳理 npm 与 npx 的角色分工，以及 package.json 核心字段。
series: npm 包管理进阶
series_order: 1
publish: blog
publish_slug: cs/frontend-series/npm-series/npm-npx-package-json
draft: false
---
