...
source_path: cs/observability-series/chrome-devtools-initiator.mdx
migrate_from: cs/observability-series/chrome-devtools-initiator.mdx
migrate_batch: blog-vault-migration-2026-03-18
summary: 借助 Network 面板中的 Initiator 视图，把一次偶然的抓包，变成可控的调试入口。
publish: blog
publish_slug: cs/observability-series/chrome-devtools-initiator
draft: false
---
