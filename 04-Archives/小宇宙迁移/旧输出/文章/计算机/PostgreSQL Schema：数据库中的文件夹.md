...
source_path: cs/backend-series/postgresql-schema.mdx
migrate_from: cs/backend-series/postgresql-schema.mdx
migrate_batch: blog-vault-migration-2026-03-18
summary: 在 PostgreSQL 中，schema 就像文件夹一样简单而强大。它让你的数据库井然有序，让复杂的事情变得简单。
publish: blog
publish_slug: cs/backend-series/postgresql-schema
draft: false
---
