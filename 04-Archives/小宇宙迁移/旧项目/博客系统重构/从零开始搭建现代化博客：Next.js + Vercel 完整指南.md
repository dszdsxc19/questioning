...
source_path: diary/blog-series/building-blog-from-scratch.mdx
migrate_from: diary/blog-series/building-blog-from-scratch.mdx
migrate_batch: blog-vault-migration-2026-03-18
summary: 记录从零开始搭建一个现代化博客的完整过程，包括为什么要搭建博客、技术选型、域名配置、DNS 解析、部署到 Vercel 等全流程，以及与 Hugo、Hexo、Jekyll
  等传统静态博客生成器的对比。
migration_flags:
- contains_import
