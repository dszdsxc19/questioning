...
- 编程工具
topic: AI编程
source_type: tool-evaluation
status: needs-split
created: '2025-12-25'
source: we-write-to-think/data/blog/zh
source_path: cs/ai-series/agentic-development/agentic-coding-tool-journey.mdx
migrate_from: cs/ai-series/agentic-development/agentic-coding-tool-journey.mdx
...
- **opencode**：目前最流行的开源 AI coding agent，使用 TypeScript 和 Go 开发，遵循 MIT 协议。很多功能比 Claude Code 好，界面也很优秀。社区非常活跃，是我目前在考虑的主要替代方案之一
...
[opencode](https://github.com/sst/opencode) 是一个特殊的开源项目，由 SST 团队开发。使用 TypeScript 和 Go 语言开发，遵循 MIT 开源协议。它目前是最流行的开源 AI coding agent 之一。

**为什么关注 opencode：**

- **功能优势**：很多功能比 Claude Code 更强大，界面也更优秀
- **开源特性**：完全开源，可以自由定制和扩展
- **社区活跃**：项目非常活跃，社区反馈积极
- **技术栈**：TypeScript + Go，性能优异

**我的使用计划：**

1. **沙箱运行时集成**：我正在开发一个沙箱运行时项目，会将 opencode 作为 agent 集成进去
2. **本地辅助使用**：除了主力使用 Claude Code 外，本地也会使用 opencode 作为辅助工具
3. **最终选择**：在 opencode 和 Claude Code 之间做最终选择，目前主力仍是 Claude Code

opencode 代表了开源社区在 AI coding agent 领域的最佳实践，值得关注。
...
**Claude Code + 多模型策略 + 国产模型补充 + opencode 实验**
...
6. **开源方案探索**：通过 opencode 探索开源 AI coding agent 的可能性，为未来的沙箱运行时项目做准备
